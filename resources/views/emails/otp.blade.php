...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ...
        <p style="color: #555; font-size: 16px;">Terima kasih telah mendaftar. Untuk menyelesaikan proses pendaftaran, silakan gunakan kode OTP berikut:</p>
        ...
        <p style="color: #555; font-size: 16px;">Kode OTP ini berlaku selama 10 menit. Jangan beritahu kode ini kepada siapa pun.</p>
