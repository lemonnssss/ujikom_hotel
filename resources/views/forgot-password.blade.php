...
<head>
    ...
    <title>Lupa Kata Sandi | Hotelku</title>
    ...
    <style>
        ...
        .link-back:hover { color: var(--accent-gold); }
    </style>
</head>
<body>
    ...
    <div class="verify-container">
        <div class="form-header">
            ...
            <p>Masukkan alamat email Anda yang terdaftar, kami akan mengirimkan OTP untuk mereset kata sandi.</p>
        </div>
        ...
        <form action="/forgot-password" method="POST">
            ...
            <div class="mb-3 text-start">
                <label class="form-label fw-bold text-uppercase" style="font-size: 12px; color: #5a6577;">Alamat Email</label>
        ...
        <a href="/login" class="link-back"><i class="fa-solid fa-arrow-left me-1"></i> Kembali ke Login</a>
    </div>
</body>
</html>
